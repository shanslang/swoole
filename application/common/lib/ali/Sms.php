...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIbNfcp35ysOPS"; // AccessKeyId

        $accessKeySecret = "K7aAoFvIMW96ZBXoq35WteNaJe64pn"; // AccessKeySecret
    ...
    public static function sendSms($mobile, $code) {
        ...
        $request->setSignName("牛仔绑定手机验证码");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_140737087");
